        ...
        <div class="span12 columns">
          ...
          <div class="well">
            <p class="muted">Tight pants next level keffiyeh
              <a href="#" data-behavior='BS.Twipsy' data-twipsy-location="above" title='Some title text'>you probably</a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel
              <a href="#" data-behavior='BS.Twipsy' data-twipsy-location="below" title='Another twipsy'>have a</a> terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa, four loko mcsweeney's cleanse vegan chambray. A
